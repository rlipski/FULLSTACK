 ...
 */
package com.rl.fs.dao;

import com.rl.fs.beans.Pracownik;
...
public class PracownikDao {
	...
	public int delete(int id) {
		String sql = "delete from pracownik "
				+ "where id='" + id + "'";
	...
	public int update(Pracownik p) {
		String sql = "update pracownik "
				+ "set nazwisko='" + p.getNazwisko() + "', pensja='" + p.getPensja() + "', firma='" + p.getFirma() + "' where id='" + p.getId() + "'";
